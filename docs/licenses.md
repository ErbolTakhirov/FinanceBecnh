...
paper claims (see that document's "Cross-cutting findings" section).

No restricted, licensed, or gated dataset content is committed to this repository. Where only a
subset of a benchmark is redistributable, only that subset is bundled or fetched by `financebench
prepare`.
